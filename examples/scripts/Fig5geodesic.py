...
for level in range(refinement_levels):
    ...
    constr_horizontal  = create_horizontal_constraint(K,xA,xB, parameters.a_weight, 
                                                      parameters.b_weight, parameters.mass_factor)
    ...
    for i in range(len(visu_path)):
        ...
        utils.write_obj_curve(file, path[i], utils.compute_lines(visu_path[0]))
